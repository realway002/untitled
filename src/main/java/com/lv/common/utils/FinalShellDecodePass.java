...
public class FinalShellDecodePass {
    public static void main(String[] args)throws Exception {
        ...
        System.out.println("172.18.183.83,username:cbossapp,pwd:"+decodePass("dSIIPndaIXobkW3WUL7NKX0+RG8V/dKL"));
        System.out.println("172.18.234.253,username:baseweb,pwd:"+decodePass("bA0NYUEHYSCDbk/vHUMtbgbSHCJE3ekA"));
        System.out.println("172.18.194.226,username:mgeop,pwd:"+decodePass("LztzfissHDrhPd9nQZm0s7H7So59uHDH"));
        System.out.println("172.18.234.254,username:baseapp,pwd:"+decodePass("Q0k+WxghcRS1ssEIdH2l82pAVa7BWINJ"));
